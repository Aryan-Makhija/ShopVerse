...
export function AdminForgotPassword({
  ...
  const handelsendotp = async (e) => {
    e.preventDefault()
    const response = await fetch("/api/admin/ForgotPassword/SendOTP", {
      method: "POST",
  ...
  const handleverifyotp = async (e) => {
    e.preventDefault()
    const response = await fetch("/api/admin/ForgotPassword/CheckOtp", {
      method: "POST",
  ...
  const handelSetNewPass = async (e) => {
    e.preventDefault()
    const response = await fetch("/api/admin/ForgotPassword/ResetPassword", {
      method: "POST",
