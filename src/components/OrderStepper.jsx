...
export default function Stepper({
  ...
  return (
    <div
      className="flex min-h-full w-full flex-1 flex-col items-center justify-center p-1 sm:aspect-[4/3] md:aspect-[2/1]"
      {...rest}>
      <div
        className={`mx-auto w-full max-w-[900px] aspect-[7/5] rounded-4xl shadow-xl ${stepCircleContainerClassName}`}
